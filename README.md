...
### DOWNLOAD -  v1.14.6 (2024-10-22)  

[JocysCom.VS.AiCompanion.App.zip](https://github.com/JocysCom/VsAiCompanion/releases/download/1.14.6/JocysCom.VS.AiCompanion.App.zip) - digitally signed standalone/portable application.
