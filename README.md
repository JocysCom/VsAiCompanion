...
### DOWNLOAD -  v1.12.6 (2024-06-30)  

[JocysCom.VS.AiCompanion.App.zip](https://github.com/JocysCom/VsAiCompanion/releases/download/1.12.6/JocysCom.VS.AiCompanion.App.zip) - digitally signed standalone/portable application.
