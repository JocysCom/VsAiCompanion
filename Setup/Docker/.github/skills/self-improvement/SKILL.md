...
**IMPORTANT:** When asked to modify skills, instructions, or perform any self-improvement task, you MUST:
...
**Example:** If asked to update `.roo/skills/self-improvement/SKILL.md`, you must edit `.ai/skills/self-improvement/SKILL.md` instead.
...
```powershell
.\.ai\skills\self-improvement\scripts\Sync-AgentAssets.ps1 AUTO
```
...
- Sync entrypoint (instructions + skills): `.ai/skills/self-improvement/scripts/Sync-AgentAssets.ps1`
