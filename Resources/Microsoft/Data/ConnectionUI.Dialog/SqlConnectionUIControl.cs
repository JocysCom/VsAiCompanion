...
namespace Microsoft.SqlServer.Management.ConnectionUI
{
    public class SqlConnectionUIControl : UserControl, IDataConnectionUIControl
    {
        ...
        public void Initialize(IDataConnectionProperties connectionProperties)
        {
            switch (connectionProperties)
            {
                ...
                case OleDBSqlConnectionProperties _:
                    ...
                    break;
                default:
                    throw new ArgumentException(SR.SqlConnectionUIControl_InvalidConnectionProperties);
            }
        }
        ...
        {
            if (ActiveControl == selectDatabaseRadioButton && (keyData & System.Windows.Forms.Keys.KeyCode) == System.Windows.Forms.Keys.Down)
            {
                attachDatabaseRadioButton.Focus();
                return true;
            }
            if (ActiveControl != attachDatabaseRadioButton || (keyData & System.Windows.Forms.Keys.KeyCode) != System.Windows.Forms.Keys.Down)
