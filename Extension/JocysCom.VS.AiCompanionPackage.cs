...
namespace JocysCom.VS.AiCompanion.Extension
{
	...
	public sealed class JocysComVsAiCompanionPackage : AsyncPackage
	{
		/// <summary>
		/// Jocys.com VS AI Companion Package GUID string.
		/// JocysComVsAiCompanionPackage.vsct/name=guidJocysComVsAiCompanionPackage
		/// </summary>
		public const string PackageGuidString = "970c15c0-d3c8-fd56-fc58-09d43c5d05d0";
