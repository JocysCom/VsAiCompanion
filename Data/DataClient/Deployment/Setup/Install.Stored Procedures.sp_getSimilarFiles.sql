IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Embedding].[sp_getSimilarFiles]') AND type in (N'P', N'PC'))
BEGIN
    PRINT 'Creating stored procedure [Embedding].[sp_getSimilarFiles]'
