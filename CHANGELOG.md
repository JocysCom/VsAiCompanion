...
- New: Automation functions that allow AI to navigate and interact with UI.
...
- New: Now, AI models can call functions even if the API doesn’t natively support them.
