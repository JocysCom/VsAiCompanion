@ECHO OFF
CALL:SIG "..\VsAiCompanion\App\bin\Release\publish\JocysCom.VS.AiCompanion.App.exe"
echo.
pause
...
set d=Jocys.com VS AI Companion
set du=https://github.com/JocysCom/E2EETool
