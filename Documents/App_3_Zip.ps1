...
& "$binDir\ZipFiles.ps1" $filesDir "$filesDir\JocysCom.VS.AiCompanion.App.zip" $file1
& "$binDir\ZipFiles.ps1" $filesDir "$filesDir\JocysCom.VS.AiCompanion.Extension.zip" $file2
