...
# Namespace the sseclient import to avoid conflicts with other pipelines
import sseclient as anthropic_sseclient
...
class Pipeline:
    ...
    def pipe(
        ...
        try:
            ...
            for message in processed_messages:
                ...
                final_messages.append({"role": message["role"], "content": processed_content})
            ...
            payload = {
                ...
                "top_k": processed_body.get("top_k", 40),
                "top_p": processed_body.get("top_p", 0.9),
                "stop_sequences": processed_body.get("stop", []),
    ...
    def stream_response(self, payload: dict) -> Generator:
        ...
        if response.status_code == 200:
            client = anthropic_sseclient.SSEClient(response)
